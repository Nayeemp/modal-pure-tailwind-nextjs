...
function Modal1({ showModal, setShowModal }) {
  return (
    <div>
      {/* <!-- Modal --> */}
      <div
        className={`fixed left-0 top-0 z-[1055] h-full w-full overflow-y-auto overflow-x-hidden outline-none bg-black transition-all duration-300 ease-in-out ${
          showModal ? 'block bg-opacity-50' : 'invisible bg-opacity-0'
        }`}
      >
        <div
